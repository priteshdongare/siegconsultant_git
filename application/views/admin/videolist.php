				...
				<div class="container">
                  ...
                  <thead>
                    ...
                    <?php
                      ...
                      foreach($list as $key=>$seller): ?>
                        <tr>
                          ...
                          <td><?php echo $seller['name']; ?></td>
                           <td>
                               <iframe width="150px" height="80px" src="https://www.youtube.com/embed/<?= $seller['video'];?>" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                      ...
                      <td>
                            <div class="btn-group">
                            <a href="<?php echo base_url(); ?>admin/Deletevideo/<?php echo $seller['id']; ?>" class="btn btn-danger btn-sm">
                              Delete
                              </a>
                            </div>
                          </td>
