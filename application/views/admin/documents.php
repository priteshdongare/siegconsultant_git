			...
			<div class="main-header">
				...
				<div class="container">
                    ...
                    <div class="row">
                        ...
                        <form class="forms-sample"  action="<?= base_url('admin/document') ?>" enctype="multipart/form-data" method="post">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="form-control "   name="pdffile[]" required id="eventbanner">
                                        </div>
                                    </div>
