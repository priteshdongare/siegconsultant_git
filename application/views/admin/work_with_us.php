				...
				<div class="container">
                  ...
                  <thead>
                    ...
                    <?php
                      ...
                      <td>
                            <div class="btn-group">
                            <a href="<?php echo base_url(); ?>admin/careerdelete/<?php echo $seller['id']; ?>" class="btn btn-danger btn-sm">
                              Delete
                              </a>
                            </div>
                          </td>
                       ...
                       ?> 
                       <tr>
                         <td colspan="8" class="text-center"> <span class="text-danger">No Data Found</span></td>
                       </tr>
                       <?php } ?>
                    </tbody>
                  </table>
